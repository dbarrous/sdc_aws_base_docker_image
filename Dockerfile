...
# Download Pre-Built CDF Binaries - Version: cdf27_2-dist-cdf
RUN wget https://sdc-aws-support.s3.amazonaws.com/cdf-binaries/cdf27_2-dist-cdf.zip

# Unzip CDF Binaries and move to /usr/local/cdf
RUN unzip cdf27_2_0-dist-cdf.zip && mv cdf /usr/local/
